...
downloadFile('https://raw.githubusercontent.com/amoreira2003/CraftPlus/main/switch/utils.lua',"./smartSwitch/utils.lua")
term.clear()
writeCentered("Dowloading Main File")
downloadFile('https://raw.githubusercontent.com/amoreira2003/CraftPlus/main/switch/smartswitch.lua',"smartSwitch.lua")
term.clear()
writeCentered("Dowloading Startup Lock File")
downloadFile('https://raw.githubusercontent.com/amoreira2003/CraftPlus/main/switch/startup.lua',"startup.lua")
term.clear()
